...
namespace Arinks\Theme\App\Setup;
...
add_filter('theme/index/sidebar/visibility', 'Arinks\Theme\App\Setup\show_index_sidebar');
add_filter('theme/single/sidebar/visibility', 'Arinks\Theme\App\Setup\show_index_sidebar');
...
add_filter('excerpt_length', 'Arinks\Theme\App\Setup\modify_excerpt_length');
