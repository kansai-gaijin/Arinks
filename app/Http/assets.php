...
namespace Arinks\Theme\App\Http;
...
add_action('wp_enqueue_scripts', 'Arinks\Theme\App\Http\register_stylesheets');
...
add_action('wp_enqueue_scripts', 'Arinks\Theme\App\Http\register_scripts');
...
add_action('admin_init', 'Arinks\Theme\App\Http\register_editor_stylesheets');
...
add_action('wp_default_scripts', 'Arinks\Theme\App\Http\move_jquery_to_the_footer');
